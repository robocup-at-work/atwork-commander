...
public:
    ...
    virtual void sendTask( atwork_refbox_msgs::Task task ) {
    ...
    virtual void onInit( ros::NodeHandle roshandle ) {
    	...
    	this->send_task_pub = this->rh.advertise<atwork_refbox_msgs::Task>("/refbox/task", 1);
    }

private:
    void receiveRobotStateClb( const atwork_refbox_msgs::RobotState::ConstPtr& msg ) {
